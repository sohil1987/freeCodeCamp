var dungeon = {
  ...
  createSize: function () {
    'use strict';
    this.map = bb.initializeMultiArray(this.cols, this.rows, 0);
  },
  ...
  createSingleRoomInCenter: function () {
    'use strict';
    var width = bb.getRandomNumber(this.minSizeRoom, this.maxSizeRoom);
    var height = bb.getRandomNumber(this.minSizeRoom, this.maxSizeRoom);
  ...
  pickRandomFeature: function () {
    'use strict';
    var type = bb.getRandomNumber(0, 100);
    ...
    switch (true) {
      case ( type < 50):
        ...
        if (this.nextFeature.dir === 1 || this.nextFeature.dir === 3) {
          ...
          this.nextFeature.height = bb.getRandomNumber(this.minLenCorridor,
            this.maxLenCorridor);
        } else if (this.nextFeature.dir === 2 || this.nextFeature.dir ===
          4) {
          this.nextFeature.width = bb.getRandomNumber(this.minLenCorridor,
            this.maxLenCorridor);
      ...
      case ( type >= 50):
        ...
        this.nextFeature.width = bb.getRandomNumber(this.minSizeRoom, this
          .maxSizeRoom);
        this.nextFeature.height = bb.getRandomNumber(this.minSizeRoom, this
          .maxSizeRoom);
        break;
    }
  },
  ...
  getFeatureDirection: function (x, y) {
    'use strict';
    var aux = bb.getRandomNumber(1, 4);
    var cont = 0;
    var ok = false;
    while (!ok && cont < 10) {
