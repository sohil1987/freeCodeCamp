...
const app = (function () {
  ...
  let counter = 0;
  let round = 0;
  const audio1 = new Audio('/freecodecamp/assets/sounds/simon/simon1.mp3');
  const audio2 = new Audio('/freecodecamp/assets/sounds/simon/simon2.mp3');
  const audio3 = new Audio('/freecodecamp/assets/sounds/simon/simon3.mp3');
  const audio4 = new Audio('/freecodecamp/assets/sounds/simon/simon4.mp3');
