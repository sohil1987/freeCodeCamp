...
var baseURL = "/freecodecamp/v1/apps/" // Go deploy

HTML Templates
"./../../voting/loQueSea" || "/voting/loQueSea "// html local
<head> <base href="/freecodecamp/v1/apps/"></head> // html deploy
...
const loginCallback = "http://brusbilis.com/freecodecamp/v1/apps/pintelest/twitter"
...
func addPicToDB(w http.ResponseWriter, r *http.Request) {
	...
	http.Redirect(w, r, "https://brusbilis.com/freecodecamp/v1/apps/pintelest/myPics", 301)
}
